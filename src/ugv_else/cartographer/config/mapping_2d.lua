...
TRAJECTORY_BUILDER_2D.min_range = 0.12  -- Gazebo/real 2D LiDAR minimum usable range
TRAJECTORY_BUILDER_2D.max_range = 30.0  -- Airport world boundaries are farther than the old indoor 3.5 m limit
