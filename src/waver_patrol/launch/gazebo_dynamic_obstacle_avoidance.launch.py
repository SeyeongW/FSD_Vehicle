    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "enable_fake_sound",
                default_value="true",
                description="Enable the simulated sound mission backend for Gazebo-only airport validation.",
            ),
            ...
            DeclareLaunchArgument(
                "target_scenario_id",
                default_value="0",
                description="Pass 1 to keep repeated airport patrol trials on the elevated dynamic H1 target path.",
            ),
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(trial_launch),
                launch_arguments={
                    "trial_id": LaunchConfiguration("trial_id"),
                    "target_scenario_id": LaunchConfiguration("target_scenario_id"),
