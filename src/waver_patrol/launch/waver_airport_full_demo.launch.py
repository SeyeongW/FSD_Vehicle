...
def generate_launch_description() -> LaunchDescription:
    ...
    default_map_save_command = (
        ...
        "ros2 run nav2_map_server map_saver_cli -f $HOME/ros2_ws/maps/patrol_map'"
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "target_scenario_id",
                default_value="1",
                description="Airport full-demo repeats the elevated dynamic H1 target scenario while logger trial_id changes.",
            ),
