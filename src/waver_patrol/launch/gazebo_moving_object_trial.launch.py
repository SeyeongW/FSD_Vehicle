...
def generate_launch_description() -> LaunchDescription:
    ...
    if not os.path.isfile(bird_manager_py):
        matches = glob.glob(os.path.expanduser("~/ugv_ws/FSD_Vehicle/src/**/bird_manager.py"), recursive=True)
        if matches:
    ...
    rosbag_command_text = PythonExpression(
        [
            "'mkdir -p ~/ugv_ws/FSD_Vehicle/experiments_result/gazebo_trial_",
            trial_id,
            ...
            "/gazebo/model_states "
            "-o ~/ugv_ws/FSD_Vehicle/experiments_result/gazebo_trial_",
            trial_id,
            "/rosbag/trial_",
            trial_id,
            "_$(date +%Y%m%d_%H%M%S)'",
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("output_root", default_value="~/ugv_ws/FSD_Vehicle/experiment_results"),
            DeclareLaunchArgument(
                "world_file",
