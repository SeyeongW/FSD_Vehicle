...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/models/dynamic_obstacle_box', glob('models/dynamic_obstacle_box/*')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'external_lidar_dynamic_bridge_node = waver_patrol.perception.external_lidar_dynamic_bridge_node:main',
            'external_yolo_bridge_node = waver_patrol.perception.external_yolo_bridge_node:main',
            'scan_republisher_node = waver_patrol.perception.scan_republisher_node:main',
            ...
            'static_map_state_publisher_node = waver_patrol.mapping.static_map_state_publisher_node:main',
            'laser_scan_occupancy_mapper_node = waver_patrol.mapping.laser_scan_occupancy_mapper_node:main',
            'target_body_tracker_node = waver_patrol.control.target_body_tracker_node:main',
            'live_target_aim_bridge_node = waver_patrol.control.live_target_aim_bridge_node:main',
            'target_observation_body_tracker_node = waver_patrol.control.target_observation_body_tracker_node:main',
            'waver_gimbal_feedback_bridge_node = waver_patrol.control.waver_gimbal_feedback_bridge_node:main',
            'camera_gimbal_controller_node = waver_patrol.control.camera_gimbal_controller_node:main',
            ...
            'sound_deterrent_node = waver_patrol.bridges.sound_deterrent_node:main',
            ...
            'mapping_backend_manager_node = waver_patrol.mapping.mapping_backend_manager_node:main',
