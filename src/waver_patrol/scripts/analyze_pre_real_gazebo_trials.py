...
def main() -> int:
    ...
    parser.add_argument("--input_dir", default=str(root / "experiments_result"))
    parser.add_argument("--output_dir", default=str(root / "experiments_result" / "results"))
    args = parser.parse_args()
    script = script_dir / "analyze_gazebo_trials.py"
