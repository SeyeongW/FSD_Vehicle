...
```text
~/ros2_ws5/FSD_Vehicle/src/waver_patrol
```

If another copy exists at `~/ros2_ws5/FSD_Vehicle/src/waver_patrol`, keep only one build-visible copy. The
...
In this workspace, `FSD_Vehicle` exists both at `~/ros2_ws5/FSD_Vehicle` and
`~/ros2_ws5/FSD_Vehicle`, so avoid a blind full-workspace build until the duplicate package paths
...
```bash
bash ~/ros2_ws5/FSD_Vehicle/src/waver_patrol/scripts/waver_real_preflight_check.sh
```
...
```bash
ls -R ~/ros2_ws5/FSD_Vehicle/experiments_result
head -n 5 ~/ros2_ws5/FSD_Vehicle/experiments_result/*/mission_events.csv
head -n 5 ~/ros2_ws5/FSD_Vehicle/experiments_result/*/radar_targets.csv
head -n 5 ~/ros2_ws5/FSD_Vehicle/experiments_result/*/experiment_summary.csv
```

Raw rosbag recording:

```bash
~/ros2_ws5/FSD_Vehicle/src/waver_patrol/scripts/record_waver_experiment_bag.sh
```
...
- CSV summary: `~/ros2_ws5/FSD_Vehicle/experiments_result/gazebo_trial_*`
...
```bash
bash ~/ros2_ws5/FSD_Vehicle/src/waver_patrol/scripts/run_pre_real_gazebo_trials.sh
```

The report is written to:

```text
~/ros2_ws5/FSD_Vehicle/experiments_result/results/pre_real_validation_report.md
```
...
ros2 launch waver_patrol remote_visualization.launch.py \
  rviz_config:=~/ros2_ws5/FSD_Vehicle/src/waver_patrol/rviz/pre_real_gazebo_validation.rviz \
  require_scan:=false
```
