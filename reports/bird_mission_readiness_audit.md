...
- actual_package_head_at_audit_generation: `86803e6`
- actual_package_branch_at_audit_generation: `jo`
- actual_package_dirty_state_at_audit_generation:

```text
M docs/repository_cleanup_policy.md
 M reports/bird_mission_readiness_audit.md
 M reports/cleanup_plan.md
 M reports/final_repair_validation_summary.md
 M reports/release_self_test/check_bird_mission_field_release_self_test.json
 M scripts/generate_bird_mission_readiness_audit.py
 M scripts/waver_conservative_cleanup_plan.py
 m src/livox_ros_driver2
 M src/waver_patrol/test/test_readiness_truthfulness_contract.py
 M src/waver_patrol/test/test_repository_cleanup_policy.py
```
